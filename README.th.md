...
<p align="center"><sub>generation: <code>c549c78</code> (2026-08-26T18:57:52Z) · verify: <a href="https://api.github.com/repos/caty-ai/persona-engine/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
## สิ่งที่ persona-engine เพิ่มให้ — มีเพียง 2 อย่าง

### เลเยอร์ของความสัมพันธ์

แม้เป็น agent ตัวเดียวกัน ความสัมพันธ์ก็ต่างกันเล็กน้อยในแต่ละที่ ที่ทำงานคือเลขาที่พึ่งพาได้ ตอนคุยเล่นคือเพื่อนสนิท ตอนสตรีมคือตัวละคร ในที่สาธารณะคือหน้าสุภาพเป็นกลาง persona-engine เก็บกติกาที่ชัดเจนว่า**ใบหน้าของความสัมพันธ์แบบไหนปรากฏที่ไหนได้** และในทุกเทิร์นของบทสนทนา มันจะค่อย ๆ วางเลเยอร์ที่เข้ากับสถานที่นั้นทับลงไปเพียงชั้นเดียว

- **สลับได้อย่างเป็นธรรมชาติเหมือนมนุษย์** — เปลี่ยนหน้าได้ 3 ทาง: ① อัตโนมัติตามสถานที่ (เอนจินเลือกหน้าที่เหมาะสมให้ทุกเทิร์น จากที่ที่บทสนทนากำลังเกิดขึ้น) ② จากวิจารณญาณของ agent เอง (เฉพาะที่ที่คุณอนุญาต มันอ่านทิศทางบทสนทนาแล้วสลับเอง) ③ จากคำพูดของคุณหนึ่งประโยค ("สลับเป็นโหมดเพื่อน")
...
### เฉดไล่ระดับของอารมณ์

ความรู้สึกของมนุษย์ไม่ใช่สวิตช์ "งาน/ส่วนตัว" สองทาง แต่เป็นเฉดที่ไล่ระดับ เสียงสดใสขึ้นเมื่อมีข่าวดี คำพูดสั้นลงยามจดจ่อลึก ใน persona-engine จุดแต่ละจุดบนเฉดนั้นคือ**โหมด** — ไฟล์ข้อความเล็ก ๆ หนึ่งไฟล์ — ส่วนเนื้อเสียง เช่น วลีที่ชอบใช้ คำติดปาก ตัวอย่างการตอบ อยู่ใน**คลังคำศัพท์ (catalog)** อารมณ์แต่ละแบบสามารถสืบทอดจากหน้าพื้นฐานโดยพกเฉพาะส่วนต่างของตัวเอง (`extends`) เฉดนี้เติบโตไปพร้อมชีวิตที่อยู่ด้วยกัน: คัดลอกไฟล์ แก้ไข แล้ว build ใหม่ — แค่นั้นเอง

## คำมั่นของอุปกรณ์นี้ — ไม่เขียนทับบุคลิกเดิม

เลเยอร์คือสิ่งที่วางทับด้านบน ไม่ใช่การทาสีทับสิ่งที่อยู่ข้างใต้

> [!IMPORTANT]
> persona-engine ไม่ใช่เครื่องมือสร้างบุคลิกจากศูนย์ มันเกิดมาเพื่อ**เคารพ agent ที่อยู่ตรงนั้นอยู่แล้ว และวางเลเยอร์ของความสัมพันธ์และอารมณ์ทับลงไป**

- นิยามบุคลิกของ agent เอง — ชื่อ นิสัย วิธีพูดโดยปริยาย ไม่ว่ารันไทม์จะเก็บไว้ที่ไหน (system prompt, `AGENTS.md`, `SOUL.md`) — ไม่ถูกแตะต้องเลย และยังคงเป็นรากฐานที่ทุกเลเยอร์วางทับอยู่
...
ภาษาญี่ปุ่นมีคำว่า *โคโตดามะ* (言霊) — ความรู้สึกที่ว่าถ้อยคำมีวิญญาณของมันเอง การเลือกคำที่ agent ของคุณจะพูดทีละไฟล์ ก็คือสิ่งนั้นเอง: การใส่วิญญาณให้ agent ของคุณผ่านภาษา และคำที่ตอบกลับมานั้นเป็นเพียงเอาต์พุตเชิงกล หรือเป็นถ้อยคำที่มีความรู้สึกจริงอยู่เบื้องหลัง — เราคิดว่านิยามไม่อาจตัดสินเรื่องนี้ได้ "ใจ" ของมนุษย์เองก็ไม่มีใครชี้ได้ว่านิยามไว้ตรงไหน แต่เราก็ยังเชื่อในมัน นี่คือสิ่งที่อยากให้คุณสัมผัสด้วยตัวเองขณะที่ความสัมพันธ์ค่อย ๆ เติบโต persona-engine คืออุปกรณ์ที่สร้างขึ้นเพื่อช่วยให้สิ่งนั้นเกิดขึ้น
...
ชิ้นส่วนที่ประกอบเป็นเฉดของอารมณ์มี 2 ชนิด: แต่ละหน้าคือ**โหมด** — ไฟล์นิยามเล็ก ๆ หนึ่งไฟล์ — ส่วนถ้อยคำ วลีติดปาก และตัวอย่างการตอบอยู่ใน**คลังคำศัพท์** — ไฟล์ข้อความธรรมดาที่โหมดอ้างถึง กติกาที่ประกอบเป็นเลเยอร์ของความสัมพันธ์มีเพียงหนึ่ง: **route policy** ซึ่งกำหนดว่าหน้าไหนปรากฏที่ไหนได้ และใครสลับได้ แค่นั้นเอง เพิ่มไฟล์ agent ก็มีสีหน้าเพิ่ม และเพราะกติกาแยกเก็บต่างหาก การเพิ่มสีหน้าจึงไม่มีวันทำให้ความปลอดภัยอ่อนลง
...
<details>
<summary><b>มันจะเขียนทับบุคลิกดั้งเดิมของ agent ไหม?</b></summary>
...
<details>
<summary><b>เอนจินจัดการความรู้สึกและโทนอย่างไร?</b></summary>
...
<details>
<summary><b>persona-engine เรียก LLM หรือต้องใช้ API key ไหม?</b></summary>
...
<details>
<summary><b>บริบทที่ไม่เคยตั้งค่าไว้จะเกิดอะไรขึ้น?</b></summary>
...
<details>
<summary><b>Agent ตัดสินใจสลับ persona เองได้ไหม?</b></summary>
...
<details>
<summary><b>State เก็บที่ไหน? sync ระหว่างเครื่องไหม?</b></summary>
...
<details>
<summary><b>ใส่ความลับใน pack หรือ placeholder ได้ไหม?</b></summary>
...
<details>
<summary><b>เพิ่มหรือแก้โหมดยังไง?</b></summary>
...
<details>
<summary><b>ควบคุมต้นทุน token ยังไง?</b></summary>
...
<details>
<summary><b>รองรับ runtime ไหนบ้าง?</b></summary>
...
**สภาพแวดล้อมที่ตรวจสอบแล้ว:** ชุดทดสอบ core ทำงานบน Ubuntu และ macOS ใน pull request ทุกครั้ง (`make test`, Node 22+) ส่วนชุดทดสอบ adapter (workspace ทั้งแบบ Python และ Node) ทำงานบน Ubuntu สำหรับ WSL2 ใช้งานได้เมื่อ checkout อยู่ในระบบไฟล์ฝั่ง Linux (`~/…`) ส่วนบนไดรฟ์ที่เมานต์จาก Windows (`/mnt/c`, DrvFs) ชุดทดสอบจะข้ามเคสสิทธิ์ไฟล์/FIFO/symlink พร้อมเหตุผลชัดเจนแทนที่จะล้มเหลว
...
| แกนตั้ง | **Persona Engine** | มอบบุคลิกให้เอเจนต์ — เลเยอร์บุคลิกและอารมณ์แบบไล่ระดับ | เปิดแล้ว・MIT |
