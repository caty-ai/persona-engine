...
<p align="center"><sub>generation: <code>5e4cdab</code> (2026-09-04T18:26:08Z) · verify: <a href="https://api.github.com/repos/caty-ai/persona-engine/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
**ข้อจำกัดที่ทราบ:** เกต CI ที่เพิ่งรวมเข้าระบบ (สแกน secret และตรวจ history, 2026-08) ยังมีประวัติการรันเพียงช่วงสั้น ๆ
...
รุ่นต่าง ๆ ถูกแท็กบน GitHub และเผยแพร่บน npm ในชื่อ `@persona-engine/core` — ดูประวัติได้ที่ [Releases](https://github.com/caty-ai/persona-engine/releases) ยินดีรับ issue และข้อเสนอ — ดู[การมีส่วนร่วม](#การมีส่วนร่วม)
